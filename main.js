...
const translations = {
  es: {
    ...
    // Footer
    "footer.tagline":    "Residencias de calidad en la península.",
    ...
    "home.nosotros.texto":  "Azul Península es un fraccionamiento residencial administrado con transparencia, donde cada residente forma parte de una comunidad comprometida con el bienestar colectivo.",
    "home.nosotros.cta":    "Conoce a la administración",

    "home.deptos.label":    "Disponibles",
    "home.deptos.titulo":   "Departamentos en renta",
    "home.deptos.texto":    "Espacios modernos y bien equipados listos para habitarse.",
    "home.deptos.cta":      "Ver catálogo completo",

    "home.contacto.label":  "¿Listo para vivir aquí?",
    "home.contacto.titulo": "Agenda una visita",
    "home.contacto.texto":  "Nuestro equipo está listo para mostrarte las opciones disponibles.",
    "home.contacto.cta":    "Contactar ahora",

    // about.html
    "about.hero.titulo":    "Nosotros",
    "about.hero.sub":       "Conoce la estructura que administra y cuida Azul Península.",
  ...
  en: {
    ...
    // Footer
    "footer.tagline":    "Quality residences on the peninsula.",
    ...
    "home.nosotros.texto":  "Azul Península is a residential community managed with transparency, where every resident is part of a collective committed to well-being.",
    ...
    "home.contacto.texto":  "Our team is ready to show you the available options.",
    "home.contacto.cta":    "Contact us",

    // about.html
    "about.hero.titulo":    "About Us",
    "about.hero.sub":       "Learn about the team that manages and cares for Azul Península.",
    ...
    "contact.hero.sub":     "We're here to help. Schedule an appointment or write to us.",
...
function initHamburger() {
  ...
  toggle.addEventListener('click', () => {
    ...
    toggle.querySelectorAll('span')[0].style.transform = isOpen ? 'rotate(45deg) translate(4.5px, 4.5px)' : '';
    toggle.querySelectorAll('span')[1].style.opacity  = isOpen ? '0' : '1';
    toggle.querySelectorAll('span')[2].style.transform = isOpen ? 'rotate(-45deg) translate(4.5px, -4.5px)' : '';
  });
